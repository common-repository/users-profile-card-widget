...
*/
class UsersProfileCardWidgetAdminPageFramework_PointerToolTip extends UsersProfileCardWidgetAdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInlineScript() {
        echo "<script type='text/javascript' class='users-profile-card-widget-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInlineScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
