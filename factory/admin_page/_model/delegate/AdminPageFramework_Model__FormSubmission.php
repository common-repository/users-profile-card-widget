...
*/
abstract class UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission_Base extends UsersProfileCardWidgetAdminPageFramework_FrameworkUtility {
...
class UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission extends UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new UsersProfileCardWidgetAdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
