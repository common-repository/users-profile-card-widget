...
*/
class UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator_Base extends UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator extends UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Link', 'UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Import', 'UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Export', 'UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Reset', 'UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
