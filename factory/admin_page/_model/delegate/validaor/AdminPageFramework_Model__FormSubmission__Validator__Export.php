...
*/
class UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Import extends UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new UsersProfileCardWidgetAdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
...
class UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Export extends UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission__Validator__Import {
    public $sActionHookPrefix = 'try_validation_after_';
    ...
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new UsersProfileCardWidgetAdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);
