...
*/
class UsersProfileCardWidgetAdminPageFramework_Property_admin_page extends UsersProfileCardWidgetAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'users-profile-card-widget') {
        ...
        $GLOBALS['aUsersProfileCardWidgetAdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aUsersProfileCardWidgetAdminPageFramework', 'aPageClasses'));
        $GLOBALS['aUsersProfileCardWidgetAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
