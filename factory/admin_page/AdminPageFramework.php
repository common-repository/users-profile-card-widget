...
abstract class UsersProfileCardWidgetAdminPageFramework_Router extends UsersProfileCardWidgetAdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'users-profile-card-widget') {
...
abstract class UsersProfileCardWidgetAdminPageFramework_Model_Form extends UsersProfileCardWidgetAdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'users-profile-card-widget') {
        ...
        new UsersProfileCardWidgetAdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new UsersProfileCardWidgetAdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class UsersProfileCardWidgetAdminPageFramework_View_Form extends UsersProfileCardWidgetAdminPageFramework_Model_Form {
...
abstract class UsersProfileCardWidgetAdminPageFramework_Controller_Form extends UsersProfileCardWidgetAdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return UsersProfileCardWidgetAdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class UsersProfileCardWidgetAdminPageFramework_Model_Page extends UsersProfileCardWidgetAdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new UsersProfileCardWidgetAdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class UsersProfileCardWidgetAdminPageFramework_View_Page extends UsersProfileCardWidgetAdminPageFramework_Model_Page {
    public function _replyToEnablePageMetaBoxes() {
        new UsersProfileCardWidgetAdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new UsersProfileCardWidgetAdminPageFramework_View__Resource($this);
    }
    ...
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new UsersProfileCardWidgetAdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class UsersProfileCardWidgetAdminPageFramework_Controller_Page extends UsersProfileCardWidgetAdminPageFramework_View_Page {
...
abstract class UsersProfileCardWidgetAdminPageFramework_Model_Menu extends UsersProfileCardWidgetAdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'users-profile-card-widget') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
        }
        new UsersProfileCardWidgetAdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class UsersProfileCardWidgetAdminPageFramework_View_Menu extends UsersProfileCardWidgetAdminPageFramework_Model_Menu {
}
abstract class UsersProfileCardWidgetAdminPageFramework_Controller_Menu extends UsersProfileCardWidgetAdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new UsersProfileCardWidgetAdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new UsersProfileCardWidgetAdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class UsersProfileCardWidgetAdminPageFramework_Model extends UsersProfileCardWidgetAdminPageFramework_Controller_Menu {
}
abstract class UsersProfileCardWidgetAdminPageFramework_View extends UsersProfileCardWidgetAdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class UsersProfileCardWidgetAdminPageFramework_Controller extends UsersProfileCardWidgetAdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new UsersProfileCardWidgetAdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, '_isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return UsersProfileCardWidgetAdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class UsersProfileCardWidgetAdminPageFramework extends UsersProfileCardWidgetAdminPageFramework_Controller {
    protected $_sStructureType = 'admin_page';
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'users-profile-card-widget') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        parent::__construct($isOptionKey, $sCallerPath ? trim($sCallerPath) : $sCallerPath = (is_admin() && (isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page'])) ? UsersProfileCardWidgetAdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), $sCapability, $sTextDomain);
    }
}
