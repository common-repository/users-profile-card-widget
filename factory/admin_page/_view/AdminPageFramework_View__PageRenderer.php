...
*/
class UsersProfileCardWidgetAdminPageFramework_View__PageRenderer extends UsersProfileCardWidgetAdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    public function render() {
        ...
        <div class="<?php echo esc_attr($this->oFactory->oProp->sWrapperClassAttribute); ?>">
            ...
            <div class="users-profile-card-widget-container">    
                <?php
        ...
        $this->_printPageMetaBoxes(); ?>     
            ...
            </div><!-- .users-profile-card-widget-container -->
    ...
    private function _getContentTop() {
        $_oScreenIcon = new UsersProfileCardWidgetAdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new UsersProfileCardWidgetAdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new UsersProfileCardWidgetAdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug) {
        ...
        echo "<div class='users-profile-card-widget-content'>";
        ...
        echo "</div><!-- .users-profile-card-widget-content -->";
    }
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new UsersProfileCardWidgetAdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'users-profile-card-widget-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
