...
*/
class UsersProfileCardWidgetAdminPageFramework_AdminNotice___Script extends UsersProfileCardWidgetAdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.users-profile-card-widget-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='users-profile-card-widget-admin-notice-animation-container'></div>" );
