...
*/
class UsersProfileCardWidgetAdminPageFramework_WPUtility_URL extends UsersProfileCardWidgetAdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(UsersProfileCardWidgetAdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(UsersProfileCardWidgetAdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = UsersProfileCardWidgetAdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility_HTML extends UsersProfileCardWidgetAdminPageFramework_WPUtility_URL {
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility_Page extends UsersProfileCardWidgetAdminPageFramework_WPUtility_HTML {
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility_Hook extends UsersProfileCardWidgetAdminPageFramework_WPUtility_Page {
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility_File extends UsersProfileCardWidgetAdminPageFramework_WPUtility_Hook {
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility_Option extends UsersProfileCardWidgetAdminPageFramework_WPUtility_File {
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility_Meta extends UsersProfileCardWidgetAdminPageFramework_WPUtility_Option {
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility_SiteInformation extends UsersProfileCardWidgetAdminPageFramework_WPUtility_Meta {
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility_SystemInformation extends UsersProfileCardWidgetAdminPageFramework_WPUtility_SiteInformation {
...
class UsersProfileCardWidgetAdminPageFramework_WPUtility extends UsersProfileCardWidgetAdminPageFramework_WPUtility_SystemInformation {
