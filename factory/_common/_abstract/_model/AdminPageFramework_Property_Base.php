...
*/
abstract class UsersProfileCardWidgetAdminPageFramework_Property_Base extends UsersProfileCardWidgetAdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'users-profile-card-widget' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aUsersProfileCardWidgetAdminPageFramework'])) {
            $GLOBALS['aUsersProfileCardWidgetAdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => UsersProfileCardWidgetAdminPageFramework_Registry::NAME, 'sURI' => UsersProfileCardWidgetAdminPageFramework_Registry::URI, 'sScriptName' => UsersProfileCardWidgetAdminPageFramework_Registry::NAME, 'sLibraryName' => UsersProfileCardWidgetAdminPageFramework_Registry::NAME, 'sLibraryURI' => UsersProfileCardWidgetAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => UsersProfileCardWidgetAdminPageFramework_Registry::getVersion(), 'sDescription' => UsersProfileCardWidgetAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => UsersProfileCardWidgetAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => UsersProfileCardWidgetAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => UsersProfileCardWidgetAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => UsersProfileCardWidgetAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new UsersProfileCardWidgetAdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
