...
abstract class UsersProfileCardWidgetAdminPageFramework_Resource_Base extends UsersProfileCardWidgetAdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'users-profile-card-widget-style';
    protected $_sClassSelector_Script = 'users-profile-card-widget-script';
    ...
    private function _getStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), UsersProfileCardWidgetAdminPageFramework_CSS::getDefaultCSS());
    ...
    private function _getIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), UsersProfileCardWidgetAdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), UsersProfileCardWidgetAdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle() {
        ...
        $this->_printCommonStyles('users-profile-card-widget-style-common', get_class());
    ...
    public function _replyToAddScript() {
        ...
        $this->_printCommonScripts('users-profile-card-widget-script-common', get_class());
