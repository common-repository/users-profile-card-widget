...
*/
abstract class UsersProfileCardWidgetAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'UsersProfileCardWidgetAdminPageFramework_Form_', 'oPageLoadInfo' => 'UsersProfileCardWidgetAdminPageFramework_PageLoadInfo_', 'oResource' => 'UsersProfileCardWidgetAdminPageFramework_Resource_', 'oHelpPane' => 'UsersProfileCardWidgetAdminPageFramework_HelpPane_', 'oLink' => 'UsersProfileCardWidgetAdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'UsersProfileCardWidgetAdminPageFramework_Debug', 'oUtil' => 'UsersProfileCardWidgetAdminPageFramework_FrameworkUtility', 'oMsg' => 'UsersProfileCardWidgetAdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(UsersProfileCardWidgetAdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
...
abstract class UsersProfileCardWidgetAdminPageFramework_Factory_Model extends UsersProfileCardWidgetAdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class UsersProfileCardWidgetAdminPageFramework_Factory_View extends UsersProfileCardWidgetAdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new UsersProfileCardWidgetAdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class UsersProfileCardWidgetAdminPageFramework_Factory_Controller extends UsersProfileCardWidgetAdminPageFramework_Factory_View {
...
abstract class UsersProfileCardWidgetAdminPageFramework_Factory extends UsersProfileCardWidgetAdminPageFramework_Factory_Controller {
}
