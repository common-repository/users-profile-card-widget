...
*/
class UsersProfileCardWidgetAdminPageFramework_FieldType_submit extends UsersProfileCardWidgetAdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".users-profile-card-widget-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";" : null, 'class' => 'users-profile-card-widget-input-label-container' . ' users-profile-card-widget-input-button-container' . ' users-profile-card-widget-input-container',);
    }
...
class UsersProfileCardWidgetAdminPageFramework_FieldType_export extends UsersProfileCardWidgetAdminPageFramework_FieldType_submit {
