...
*/
class UsersProfileCardWidgetAdminPageFramework_Form___SubmitNotice extends UsersProfileCardWidgetAdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new UsersProfileCardWidgetAdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new UsersProfileCardWidgetAdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
