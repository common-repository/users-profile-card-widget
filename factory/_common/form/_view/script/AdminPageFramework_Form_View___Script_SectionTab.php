...
*/
class UsersProfileCardWidgetAdminPageFramework_Form_View___Script_SectionTab extends UsersProfileCardWidgetAdminPageFramework_Form_View___Script_Base {
...
jQuery( '.users-profile-card-widget-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='users-profile-card-widget-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
