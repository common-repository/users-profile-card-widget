...
*/
class UsersProfileCardWidgetAdminPageFramework_Form_View___Script_Widget extends UsersProfileCardWidgetAdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.users-profile-card-widget-sectionset' ).length <= 0 ) { 
                    return; 
                }   
