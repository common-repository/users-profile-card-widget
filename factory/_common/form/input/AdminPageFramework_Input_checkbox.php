...
*/
abstract class UsersProfileCardWidgetAdminPageFramework_Input_Base extends UsersProfileCardWidgetAdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'users-profile-card-widget-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'users-profile-card-widget-input-label-string',),);
...
class UsersProfileCardWidgetAdminPageFramework_Input_checkbox extends UsersProfileCardWidgetAdminPageFramework_Input_Base {
    public function get() {
