...
*/
class UsersProfileCardWidgetAdminPageFramework_Form_Model___Modifier_SortInput extends UsersProfileCardWidgetAdminPageFramework_Form_Model___Modifier_Base {
    public $aInput = array();
